...
AbstractProgramHeader::AbstractProgramHeader(const char* p_data, boost::uint16_t p_size,
    ...
    : m_program_header32(), m_program_header64(), m_is64(p_is64), m_isLE(p_isLE) {
  if (p_is64) {
...
bool AbstractProgramHeader::is64() const { return m_is64; }

bool AbstractProgramHeader::isLE() const { return m_isLE; }
