...
namespace {
bool parseCommandLine(int p_argCount, char* p_argArray[], std::string& p_file,
                      std::string& p_directory, bool& p_print, bool& p_printReasons,
                      bool& p_capabilities) {
  boost::program_options::options_description description("options");
  description.add_options()("help", "A list of command line options")(
      ...
      "The directory to look through.")("reasons,r", "Print the scoring reasons")(
 ...
 */
void do_parsing(const std::string& p_fileName, bool p_printReasons, bool p_printCapabilities,
                bool p_printELF) {
  ELFParser parser;
...
int main(int p_argCount, char* p_argArray[]) {
  ...
  if (!parseCommandLine(p_argCount, p_argArray, fileName, directoryName, printElf, printReasons,
                        printCapabilities)) {
    return EXIT_FAILURE;
  }
