...
class AbstractSectionHeader {
 public:
  AbstractSectionHeader(const char* p_data, boost::uint16_t p_size, const char* p_file,
                        boost::uint64_t p_fileSize, boost::uint8_t p_strIndex,
                        const std::vector<AbstractSectionHeader>& p_sections, bool p_is64,
                        bool p_isLE);
