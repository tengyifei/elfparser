...
class DynamicSection {
 public:
  ...
  void createDynamic(const char* p_start, boost::uint32_t p_offset, boost::uint32_t p_size,
                     boost::uint64_t p_baseAddress, bool p_is64, bool p_isLE,
 ...
 private:
  void doDynamic64(const elf::dynamic::dynamic_64* p_dynamic, const char* p_start,
                   const char* p_end, boost::uint64_t p_baseAddress, bool p_isLE);
  void doDynamic32(const elf::dynamic::dynamic_32* p_dynamic, const char* p_start,
                   const char* p_end, boost::uint64_t p_baseAddress, bool p_isLE);
